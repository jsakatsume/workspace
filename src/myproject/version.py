...
def _get_hatch_version() -> str:
    ...
    """
    from hatchling.metadata.core import ProjectMetadata  # type: ignore[import]
    from hatchling.plugin.manager import PluginManager  # type: ignore[import]
    from hatchling.utils.fs import locate_file  # type: ignore[import]
